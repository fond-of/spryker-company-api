...
{
    /**
     * @var \FondOfSpryker\Zed\CompanyApi\Communication\Plugin\Api\CompanyApiResourcePlugin
     */
    ...
    {
        $this->assertSame(CompanyApiConfig::RESOURCE_COMPANIES, $this->companyApiResourcePlugin->getResourceName());
    }
    ...
    public function testAdd(): void
    {
        ...
        $this->assertInstanceOf(ApiItemTransfer::class, $this->companyApiResourcePlugin->add($this->apiDataTransferMock));
    }
    ...
    public function testGet(): void
    {
        ...
        $this->assertInstanceOf(ApiItemTransfer::class, $this->companyApiResourcePlugin->get($this->idCompany));
    }
    ...
    public function testUpdate(): void
    {
        ...
        $this->assertInstanceOf(ApiItemTransfer::class, $this->companyApiResourcePlugin->update($this->idCompany, $this->apiDataTransferMock));
    }
    ...
    public function testRemove(): void
    {
        ...
        $this->assertInstanceOf(ApiItemTransfer::class, $this->companyApiResourcePlugin->remove($this->idCompany));
    }
    ...
    public function testFind(): void
    {
        ...
        $this->assertInstanceOf(ApiCollectionTransfer::class, $this->companyApiResourcePlugin->find($this->apiRequestTransferMock));
    }
}
